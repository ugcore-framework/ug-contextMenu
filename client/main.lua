...
if Debug then
	...
	RegisterCommand('ctx:preview', function()
		exports['ug-context']:Preview(position, eles)
	end, false)

	RegisterCommand('ctx:open', function()
		exports['ug-context']:Open(position, eles, onSelect, onClose)
	end, false)
	...
	RegisterCommand('ctx:form', function()
		...
		exports['ug-context']:Open(position, formMenu, onSelect, onClose)
	end, false)
end